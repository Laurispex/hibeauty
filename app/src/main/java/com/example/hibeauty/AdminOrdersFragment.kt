...
class AdminOrdersFragment : Fragment() {
    ...
    private fun loadOrders() {
        ...
        db.collection("orders")
            ...
            .addOnSuccessListener { result ->
                ...
                if (orders.isEmpty()) {
                    binding.adminOrdersEmptyText.isVisible = true
                    binding.adminOrdersEmptyText.text = "Todavia no hay pedidos."
                    binding.adminOrdersRecyclerView.isVisible = false
            ...
            .addOnFailureListener {
                binding.adminOrdersEmptyText.isVisible = true
                binding.adminOrdersEmptyText.text = "No se pudieron cargar los pedidos."
                binding.adminOrdersRecyclerView.isVisible = false
            }
    }
    ...
    private fun updateOrderStatus(order: Order) {
        ...
        if (nextStatus == null) {
            toast("Este pedido ya esta finalizado")
            return
        }
        ...
        db.collection("orders")
            ...
            .addOnSuccessListener {
                toast("Pedido actualizado a $nextStatus")
                loadOrders()
            }
            .addOnFailureListener {
    ...
    private fun documentToOrder(documentId: String, data: Map<String, Any>): Order {
